...
class WithdrawalsControllerTest < ActionController::TestCase
  ...
  test "should create withdrawal" do
    assert_difference('Withdrawal.count') do
      post :create, withdrawal: { amount: @withdrawal.amount, collector: @withdrawal.collector, date: @withdrawal.date }
    end
  ...
  test "should update withdrawal" do
    patch :update, id: @withdrawal, withdrawal: { amount: @withdrawal.amount, collector: @withdrawal.collector, date: @withdrawal.date }
    assert_redirected_to withdrawal_path(assigns(:withdrawal))
  end
